...
from codex_flow.contracts import ModelFacingResult, ModelResultStatus, ModelValidation, model_facing_result_schema
...
def test_prepare_is_sdk_free_closed_and_idempotent() -> None:
    with TemporaryDirectory() as directory:
        ...
        assert first.action.prompt == capsule.prompt
