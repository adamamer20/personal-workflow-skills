...
| --- | --- | --- |
| Current/history program documentation convention | Candidate `3a4125a` received P1 `DOC-POLICY-001`; repair `ea5eaa7` restores retained-contract reachability and capsule identity in both templates. Three causal tests, validator and full `make check` with 1,270 tests are green. Plugin 0.1.16 and codex-flow 0.2.0 are installed with source parity | Focused causal re-review of `DOC-POLICY-001`, then append the closure record |
