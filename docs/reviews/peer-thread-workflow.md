...
| --- | --- | --- |
| Current/history program documentation convention | Closed at `3a4125a` + repair `ea5eaa7`: retained-contract reachability and exact capsule identities are preserved in both templates; focused Sol Medium causal re-review accepted with P0=0/P1=0. Three causal tests, validator and full `make check` with 1,270 tests are green | Plugin 0.1.16 and codex-flow 0.2.0 are installed with source parity; see history closure record |
