...
def validate_native_routing_contract() -> None:
    ...
    readme_required = (
        ...
        "Astra Medium implements and Astra High performs",
...
def validate_global_agents_template() -> None:
    ...
    required_text = (
        ...
        "Objective code review uses Luna XHigh",
        "Architecture-conformance review uses Astra Medium",
        "single mutable implementation owner",
        "independent visual-quality promotion review uses Astra High",
